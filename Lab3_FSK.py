...
class Lab3_FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab3_FSK")
        ...
        self.filter_cutoff = filter_cutoff = 7.5e3
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1,samp_rate,filter_cutoff,filter_transition), freq, samp_rate)
        ...
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(((math.pi*fsk_deviation_hz)/samp_rate))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_frequency_modulator_fc_0.set_sensitivity(((math.pi*self.fsk_deviation_hz)/self.samp_rate))
...
def main(top_block_cls=Lab3_FSK, options=None):
